      ...
      <div style={{ width: '38%', borderRight:'1px solid #D9E2EC' , paddingRight: 12, display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
          ...
          <input 
            ...
            style={{ 
              width: '100%',backgroundColor: '#FFFFFF', color: '#1F2937',  
          ...
          <>gir
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <input 
                ...
                style={{ flex: 1, backgroundColor: '#FFFFFF', color:'#1F2937' , border:'1px solid #D9E2EC' , borderRadius: '12px', padding: '6px 12px' }} 
              />
